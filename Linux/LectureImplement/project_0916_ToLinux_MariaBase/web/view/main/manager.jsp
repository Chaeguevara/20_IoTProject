...
<div id="center">
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="search-book col-lg-12">
					<h1 class="text-white">전체 도서관 이용 내역을 조회</h1>
					<p>대출 / 연체 / 좌석 </p>
					<div class="link-nav">
	...
	<section class="sample-text-area">
		<div class="container border-top-generic">
			<h3 class="text-heading">전체 도서 현황 조회</h3>
			...
			<div class="progress-table">
				...
				<c:forEach var="resb" items="${resbook }" varStatus="loop">
					<div class="table-row">
						...
						<div class="country"> ${resb.userid }</div>
						<div class="country"> 
	...
	<section class="sample-text-area">
		<div class="container border-top-generic">
			<h3 class="text-heading">모든 사용자 연체도서조회</h3>
			...
			<div class="progress-table">
				...
				<c:forEach var="lb" items="${lateresbook }" varStatus="loop">
					<div class="table-row">
						...
						<div class="country"> ${lb.userid }</div>
						<div class="country"> 
