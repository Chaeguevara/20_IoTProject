...
public class SendAndReceiveSerialDev implements SerialPortEventListener {
	...
	public SendAndReceiveSerialDev(String portName, boolean mode) {
	...
	public void serialEvent(SerialPortEvent event) { // CAN 장비에서 데이터가 발생하면 받는다.
		...
		case SerialPortEvent.DATA_AVAILABLE:
			...
			try {
				...
				// W2810003 - 앞의 8자리는 통신 코드 + 아이디. 맨뒤의 두자리는 모르겠음. 앞의 8자리, 뒤의 2자리
...
//				}
	...
	public static void main(String args[]) throws IOException {
		...
		SendAndReceiveSerialDev ss = new SendAndReceiveSerialDev("COM8", true);// true는 크게 신경쓰지 않을 것. 내 장치중 어떤 포트를
																				// 이용하겠다.
		ss.sendSerial("W2810003B010000000000005011", "10003B01"); // CAN에 보낼 메세지와 ID. 데이터를 보낼 수 있는 칸은 10칸으로 정해져있음. 16진수를
																	// 사용.
